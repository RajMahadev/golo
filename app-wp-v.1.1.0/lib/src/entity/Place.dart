...
import 'package:Golo/src/entity/Comment.dart';
...
class Place extends Base {
  ...
  Place(Map<String, dynamic> json) : super(json) {
    ...
    // cateogries
    categories = json["place-categories"] != null
        ? json["place-categories"].cast<int>()
        : [];
    // amenities
    amenities = json["place-amenities"] != null
        ? json["place-amenities"].cast<int>()
        : [];
    // cities
  ...
  String? getCategoryName() {
    return AppState().categories.firstWhere((cat) {
      return cat.id == categories!.first;
    }).name;
  }
