        ...
        child: Column(
          children: <Widget>[
            Container(
                ...
                height: calculateHeight(widget.place!.address),
                ...
                child: Visibility(
                  ...
                  visible: isVisible(widget.place!.address),
                )),
            Container(
                height: calculateHeight(widget.place!.email),
                alignment: Alignment.centerLeft,
                child: Visibility(
                  child: GestureDetector(
                      onTap: () {
                        MyUrlHelper.mailTo(widget.place!.email);
                      },
                      child: Row(
                        children: <Widget>[
                          ...
                          Container(
                              margin: EdgeInsets.only(left: 20),
                              child: SelectableText(widget.place!.email ?? "-",
                                  style: TextStyle(
                                      fontFamily: GoloFont,
                                      fontSize: 17,
                                      color: GoloColors.secondary2)))
