...
import 'package:Golo/src/providers/request_services/Api+search.dart';
import 'package:Golo/src/views/home/search/search_result_cell.dart';
  ...
  Future search(String text) async {
    return ApiSearch.searchPlaces(text).then((response) {
      _searchPlaces = List<Place>.generate(response.json!.length, (i) {
        ...
        p.cityName = widget.cities!.firstWhere((c) {
          return c.id == p.cities!.first;
        }).name;
        return p;
      });
      setState(() {});
